...
if use_conv4
    ...
    roi_database_name = 'roidb_conv4_package.mat'; %conv4
else
	[conf_proposal.anchors, conf_proposal.output_width_map, conf_proposal.output_height_map] ...
	      = proposal_prepare_anchors(conf_proposal, model.rpn_cache_name, model.premodel_file);
	roi_database_name = 'roidb_package.mat'; %conv5
end

% load roi info, it not exist, create at once and save it as .mat file
try
