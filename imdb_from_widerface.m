...
switch image_set
    case {'trainval'}
        cache_imdb = 'data/cache/cache_train_imdb.mat';  %imdb (== image database)
        cache_roidb = 'data/cache/cache_train_roidb.mat';  %roidb (== roi database)
        devpath = 'WIDER_train/images';
        doc_dir = 'wider_face_split/wider_face_train';
        name = 'WIDERFACE_train';
    case {'test'}
        cache_imdb = 'data/cache/cache_test_imdb.mat';  %imdb (== image database)
        cache_roidb = 'data/cache/cache_test_roidb.mat';  %roidb (== roi database)
