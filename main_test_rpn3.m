...
load('res_0920_conv4/net-epoch-6.mat');  %net
...
conf = load('res_0920_conv4/output_map_conv4.mat');
...
load('res_0920_conv4/bbox_stat_conv4.mat'); %bbox_means, bbox_stds
...
%         rectangle('Position', rect_anchor, 'LineWidth', 1, 'EdgeColor', [1 0 0]);
    ...
    saveName = sprintf('test_result/img_%d_conv4_0921',i);
